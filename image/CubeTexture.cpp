...
namespace Core {
    ...
    std::weak_ptr<CubeTexture> CubeTexture::build(RawImage *front, RawImage *back, RawImage *top, 
        ...
        std::shared_ptr<CubeTexture> texture = std::shared_ptr<CubeTexture>(new CubeTexture());
        texture->textureId = (Int32)tex;
        return texture;
    }
}